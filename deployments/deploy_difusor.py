...
endpoint_name = "difusor-endpoint"
...
try:
    ...
    endpoint = ManagedOnlineEndpoint(
        name=endpoint_name,
        description="Endpoint para modelo difusor",
        auth_mode="key"
    )
...
environment = Environment(
    ...
    description="Entorno para difusor con keras, sklearn y pandas"
)
...
deployment = ManagedOnlineDeployment(
    ...
    model=f"azureml:difusor_model_completo:1",  # Asegúrate del número de versión
    environment=environment,
    instance_type="Standard_DS2_v2",
    instance_count=1,
    code_configuration=CodeConfiguration(
        code="./deployments/difusor",
